...
def run_train(model, model_name, train_dataloader):
    torch.multiprocessing.freeze_support()
...
if __name__ == '__main__':
    results = '/home/arvc/Juanjo/develop/Extension Orlando/results_prueba.csv'
    ...
    with open(results, 'w', newline='') as file:
        ...
        for model_base_name in models_names:
            ...
            for training_sequence in training_sequences:
                ...
                run_train(model, model_name, training_sequence)
